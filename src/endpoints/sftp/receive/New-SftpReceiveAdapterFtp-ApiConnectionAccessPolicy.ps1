...
.EXAMPLE
.\New-SftpReceiveAdapterSftp-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\sftpreceiveadaptersftp.apiconnectionaccesspolicy.json" -templateParameterFile ".\sftpreceiveadaptersftp.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "sftpreceiveadaptersftp.apicaccesspolicy.xxxxx"
#>
