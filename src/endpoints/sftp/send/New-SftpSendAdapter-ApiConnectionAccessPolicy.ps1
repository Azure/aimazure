...
.EXAMPLE
.\New-SftpSendAdapterSftp-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\sftpsendadapter.apiconnectionaccesspolicy.json" -templateParameterFile ".\sftpsendadapter.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "sftpsendadapter.apicaccesspolicy.xxxxx"
#>
