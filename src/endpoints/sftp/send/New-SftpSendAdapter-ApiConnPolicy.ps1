...
.EXAMPLE
.\New-SftpSendAdapterSftp-ApiConnPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\sftpsendadapter.apiconnpolicy.json" -templateParameterFile ".\sftpsendadapter.apiconnpolicy.dev.parameters.json" -deploymentName "sftpsendadapter.apicaccesspolicy.xxxxx"
#>
