...
.EXAMPLE
.\New-FtpReceiveAdapterServiceBus-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\ftpreceiveadapterservicebus.apiconnectionaccesspolicy.json" -templateParameterFile ".\ftpreceiveadapterservicebus.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "ftpreceiveadapterservicebus.apicaccesspolicy.xxxxx"
#>
