...
.EXAMPLE
.\New-FtpSendAdapterFtp-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\ftpsendadapter.apiconnectionaccesspolicy.json" -templateParameterFile ".\ftpsendadapter.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "ftpsendadapter.apicaccesspolicy.xxxxx"
#>
