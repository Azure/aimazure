<#
.SYNOPSIS
Creates an file receive service bus api connection access policy.
...
.EXAMPLE
.\New-FileReceiveAdapterServiceBus-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\filereceiveadapterservicebus.apiconnectionaccesspolicy.json" -templateParameterFile ".\filereceiveadapterservicebus.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "filereceiveadapterservicebus.apicaccesspolicy.xxxxx"
#>
