<#
.SYNOPSIS
Creates a filesystem send api connection access policy.
...
.EXAMPLE
.\New-FileSendAdapterFile-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\filesystemsendadapter.apiconnectionaccesspolicy.json" -templateParameterFile ".\filesystemsendadapter.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "filesystemsendadapter.apicaccesspolicy.xxxxx"
#>
