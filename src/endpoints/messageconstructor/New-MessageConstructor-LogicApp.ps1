...
.EXAMPLE
./New-MessageConstructor-LogicApp.ps1 -resourceGroupName "rg-aimapp-systemapplication-dev-uksouth" -templateFile ".\messageconstructor.logicapp.json" -templateParameterFile ".\messageconstructor.logicapp.dev.parameters" -keyVaultName "kv-aimrstore-dev-xxxxx" -keyVaultApimSubscriptionSecretName "aim-apim-subscriptionkey-unlimited" -deploymentName "messageconstructor.logicapp.uksouth.xxxxx"
#>
