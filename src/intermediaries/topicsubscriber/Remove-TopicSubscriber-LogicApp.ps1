...
.EXAMPLE
.\Remove-TopicSubscriber-LogicApp.ps1 -resourceGroupName "rg-aimmsgbus-dev-uksouth-xxxxx" -workflowName "logic-aimtopicsubscriber-aim-ftppassthru-sendport-dev-xxxxx"
#>
