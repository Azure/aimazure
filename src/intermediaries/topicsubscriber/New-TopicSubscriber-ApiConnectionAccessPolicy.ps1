...
.EXAMPLE
.\New-TopicSubscriber-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\topicsubscriber.apiconnectionaccesspolicy.json" -templateParameterFile ".\topicsubscriber.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "topicsubscriber.apicaccesspolicy.xxxxx"
#>
