...
.EXAMPLE
.\New-FlatFileDecoder-LogicApp.ps1 -resourceGroupName "rg-aimmsgbus-dev-uksouth-xxxxx" -templateFile ".\flatfiledecoder.logicapp.json" -templateParameterFile ".\flatfiledecoder.logicapp.dev.parameters" -keyVaultName "kv-aimrstore-dev-xxxxx" -keyVaultApimSubscriptionSecretName "aim-apim-subscriptionkey-unlimited" -deploymentName "flatfiledecoder.logicapp.uksouth.xxxxx"
#>
