...
{
	Write-Host ""
	Write-Host "Welcome to the Microsoft BTS Migrator tool Deployment Script v$version, Logic Apps Standard edition." -ForegroundColor $defaultForegroundColour
	Write-Host ""
	Write-Host "This script will attempt to deploy all migrated resources, using the Logic Apps Standard offering." -ForegroundColor $defaultForegroundColour
	Write-Host ""
	...
	Write-Host "   2) Is the Azure CLI LogicApp extension installed?" -ForegroundColor $defaultForegroundColour
	Write-Host "   3) Can you login to the Azure CLI?" -ForegroundColor $defaultForegroundColour
	Write-Host "   4) Have you selected a subscription?" -ForegroundColor $defaultForegroundColour
	Write-Host "   5) Is the Azure App Configuration resource provider registered?" -ForegroundColor $defaultForegroundColour
	Write-Host "   6) Is there a Free SKU App Configuration instance deployed?" -ForegroundColor $defaultForegroundColour
	Write-Host ""
