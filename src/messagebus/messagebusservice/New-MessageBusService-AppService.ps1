<#
.SYNOPSIS
Creates an App Service resource for the routing store, routing manager and messaging manager.
...
.EXAMPLE
./New-MessageBusService-AppService.ps1 -resourceGroupName "rg-aimmsgbus-dev-uksouth" -templateFile ".\messagebusservice.plan.json" -templateParameterFile ".\messagebusservice.plan.dev.parameters" -deploymentName "messagebusservice.plan"
#>
