...
.EXAMPLE
.\New-AppConfigStore-RoleAssignment.ps1 -appConfigStoreName "appcfg-aimrstore-dev-xxxxx" -logicAppName "logic-messagebus-dev-xxxxx" -logicAppResourceGroupName "rg-aimmsgbus-dev-uksouth-xxxxx" -roleName "Contributor"
#>
