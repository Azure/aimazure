...
.EXAMPLE
.\New-MessageBusEventGrid-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimmsgbus-dev-uksouth-xxxxx" -templateFile ".\messagebuseventgrid.apicaccesspolicy.json" -templateParameterFile ".\messagebuseventgrid.apicaccesspolicy.dev.parameters.json" -deploymentName "messagebuseg.apicaccesspolicy.uksouth.xxxxx"
#>
