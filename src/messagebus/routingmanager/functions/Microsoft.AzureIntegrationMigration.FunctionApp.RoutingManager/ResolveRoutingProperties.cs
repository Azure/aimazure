...
{
    /// <summary>
    /// Azure Function that calculates the routing properties for a given message, and returns them in the supplied envelope.
    /// </summary>
    public static class ResolveRoutingProperties
    {
        /// <summary>
        /// Default prefix to add to log messages.
        /// </summary>
        private const string LogId = "ResolveRoutingProperties";
        ...
        [FunctionName("ResolveRoutingProperties")]
