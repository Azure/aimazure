...
.EXAMPLE
.\New-MessageResponseHandlerServiceBus-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\messageresponsehandlerservicebus.apiconnectionaccesspolicy.json" -templateParameterFile ".\messageresponsehandlerservicebus.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "messageresponsehandlerservicebus.apicaccesspolicy.xxxxx"
#>
