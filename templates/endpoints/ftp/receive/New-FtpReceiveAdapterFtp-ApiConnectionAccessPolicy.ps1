...
.EXAMPLE
.\New-FtpReceiveAdapterFtp-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\ftpreceiveadapterftp.apiconnectionaccesspolicy.json" -templateParameterFile ".\ftpreceiveadapterftp.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "ftpreceiveadapterftp.apicaccesspolicy.xxxxx"
#>
