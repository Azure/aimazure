...
.EXAMPLE
.\New-SftpReceiveAdapterServiceBus-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\sftpreceiveadapterservicebus.apiconnectionaccesspolicy.json" -templateParameterFile ".\sftpreceiveadapterservicebus.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "sftpreceiveadapterservicebus.apicaccesspolicy.xxxxx"
#>
