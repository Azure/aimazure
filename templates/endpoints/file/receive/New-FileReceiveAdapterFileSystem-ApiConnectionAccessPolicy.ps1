...
.EXAMPLE
.\New-FileReceiveAdapterFileSystem-ApiConnectionAccessPolicy.ps1 -resourceGroupName "rg-aimapp-application-dev-uksouth-xxxxx" -templateFile ".\filereceiveadapterfilesystem.apiconnectionaccesspolicy.json" -templateParameterFile ".\filereceiveadapterfilesystem.apiconnectionaccesspolicy.dev.parameters.json" -deploymentName "filereceiveadapterfile.apicaccesspolicy.xxxxx"
#>
