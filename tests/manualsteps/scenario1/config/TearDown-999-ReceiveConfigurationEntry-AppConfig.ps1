<#
.SYNOPSIS
Invokes the teardown of receive configuration entry configuration from application configuration.
...
.EXAMPLE
.\TearDown-999-ReceiveConfigurationEntry-AppConfig.ps1 -uniqueDeploymentId 'xxxxx'
#>
...
$params = Get-Content -Path $PSScriptRoot\receiveconfigurationentry.appcfg.dev.psparameters.json -Raw | ConvertFrom-Json
